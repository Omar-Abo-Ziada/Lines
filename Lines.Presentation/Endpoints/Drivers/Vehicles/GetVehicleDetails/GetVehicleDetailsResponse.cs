...
public record GetVehicleDetailsResponse(
    ...
    bool IsVerified,
    string Status,
    List<VehiclePhotoResponse> VehiclePhotos,
    LicenseInfoResponse? LicenseInfo,
...
public class GetVehicleDetailsResponseMappingConfig : IRegister
{
    public void Register(TypeAdapterConfig config)
    {
        config.NewConfig<VehicleDetailsDto, GetVehicleDetailsResponse>()
        ...
        config.NewConfig<VehiclePhotoDto, VehiclePhotoResponse>()
            .Map(dest => dest.PhotoUrl, src => src.PhotoUrl)
            .Map(dest => dest.Description, src => src.Description)
            .Map(dest => dest.IsPrimary, src => src.IsPrimary);

        config.NewConfig<LicenseInfoDto, LicenseInfoResponse>()
        ...
        config.NewConfig<VehicleTypeDto, VehicleTypeResponse>()
